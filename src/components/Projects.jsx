  ...
  return (
    <div className="flex justify-center pt-32 dark:bg-grey dark:text-white">
      <div className="max-w-6xl">
        ...
        <div className=" justify-between flex w-[100%] flex-wrap sm:justify-center sm:gap-8">
          {currentData.projects.map.map((item) => {
            return (
              <div className="flex flex-col justify-between  w-[45%] sm:w-[70%]">
                <div
                  className={`flex flex-col gap-8  ${item.color}  pl-8 rounded-xl pt-12 ${item.dark} h-[100%] justify-between`}
                >
